...
def main():
    ...
    parser.add_argument('--checkpoint', type=str, default='/data/home/zy3023/code/hand/Dyn-HaMR/', help='Path to pretrained model checkpoint')
    ...
    for img_path in img_paths:
        ...
        for batch in dataloader:
            ...
            for n in range(batch_size):
                ...
                #                             scene_bg_color=(1, 1, 1),
                #                             side_view=True)
                #     print('side_img: ', side_img.shape, regression_img.shape, input_patch.shape)
                ...
                bbox = batch['bbox'][n].detach().cpu().numpy()
        ...
        if args.full_frame and len(all_verts) > 0:
            ...
            all_pred_2d = np.concatenate([all_pred_2d, np.ones((all_pred_2d.shape[0], all_pred_2d.shape[1], 1))], axis=-1)
            ...
            # draw 2d keypoints
            cv2.imwrite(os.path.join(args.out_folder, f'{img_fn}_all_2d.jpg'), pred_img)
